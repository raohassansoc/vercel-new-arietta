...
export const DEFAULT_META: PageMeta = {
  title: 'Arietta Swap',
  description:
    'The most popular AMM on BSC by user count! Initial Farm Offerings (new token launch model pioneered by Arietta), NFTs, and more, on a platform you can trust.',
  image: 'https://ariettachain.com/wp-content/uploads/2023/11/ezgif.com-gif-maker-1.webp',
}
