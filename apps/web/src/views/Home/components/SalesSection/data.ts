...
export const swapSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t('Trade any token on Arietta Smart Chain in seconds, just by connecting your wallet.'),
  reverse: false,
  primaryButton: {
    to: '/swap',
    text: t('Trade Now'),
...
export const earnSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t('Arietta Swap makes it easy to make your crypto work for you.'),
  reverse: true,
  primaryButton: {
    to: '/farms',
    text: t('Explore'),
