  ...
  return [
    {
      ...
      description: [
        t(
          'Trades are settled in WBNB, which is a wrapped version of BNB used on Arietta Smart Chain. That means that when you sell an item, WBNB is sent to your wallet instead of BNB.',
        ),
