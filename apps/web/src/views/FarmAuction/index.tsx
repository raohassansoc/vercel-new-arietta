...
const FAQS_BG_LIGHT = 'linear-gradient(180deg, #CBD7EF 0%, #f3fab8 100%)'
const FAQ_BG_DARK = 'linear-gradient(180deg, #b2af4d 0%, #b2af4d 100%)'
    ...
    <>
      ...
      <>
        ...
        <PageSection
          ...
          clipFill={{ light: '#CBD7EF', dark: '#b2af4d' }}
