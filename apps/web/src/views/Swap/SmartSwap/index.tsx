...
export function SmartSwapForm() {
  ...
  console.log("My Input Currency ID ===> ",inputCurrencyId)
  console.log("My Output Currency ID ===> ",outputCurrencyId)

  console.log("my Input Currency ====> ", inputCurrency)
  console.log("my Output Currency ====> ", outputCurrency)
