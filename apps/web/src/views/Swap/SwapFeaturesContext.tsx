...
const CHART_SUPPORT_CHAIN_IDS = [ChainId.BSC, ARIETTA_ID]
const ACCESS_TOKEN_SUPPORT_CHAIN_IDS = [ChainId.BSC, ARIETTA_ID]
const STABLE_SUPPORT_CHAIN_IDS = [ChainId.BSC_TESTNET, ChainId.BSC, ARIETTA_ID]
