...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    const warningText = t("please make sure you're visiting https://ariettachain.com/ - check the URL carefully.", { domain: DOMAIN })
  ...
  return (
    <Container className="warning-banner">
      ...
      <AtomBox display={{ xs: 'none', lg: 'flex' }} alignItems="center" justifyContent="center" width="full">
        <InnerContainer>
          <img style={{width:'50%'}} src="https://ariettachain.com/wp-content/uploads/2023/05/cropped-coin-logo-A-01.png" alt="phishing-warning" width="78px" />
