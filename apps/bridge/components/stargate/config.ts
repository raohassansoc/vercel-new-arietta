import { arbitrum, mainnet, optimism, polygon, avalanche, fantom,bscTestnet } from 'wagmi/chains'
...
export const CHAINS_STARGATE = [ariettaMainNet , ariettaTestNet , mainnet, arbitrum, optimism, polygon, avalanche, fantom]
