  ...
  return (
    ...
    >
      <Flex flexDirection="column" width={["100%", null, "1200px;"]}>
        ...
        >
          {items?.map((item) => (
            <StyledList style={{display:'none'}} key={item.label}>
        ...
        <StyledToolsContainer
          ...
          justifyContent="space-between"
        >
          <Flex  style={{display:'none'}} order={[2, null, 1]} alignItems="center">
          ...
          <Flex style={{display:'none'}} order={[1, null, 2]} mb={["24px", null, "0"]} justifyContent="space-between" alignItems="center">
            <Box mr="20px">
